"""Pytest configuration for the Student 2 test suite.
...
STUDENT_2_DIR = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))

# Isolate the database service's SQLite file before it is imported.
_TMP_DATA = tempfile.mkdtemp(prefix="student2-test-")
os.environ.setdefault("DATA_DIR", _TMP_DATA)

sys.path.insert(0, os.path.join(STUDENT_2_DIR, "database"))
sys.path.insert(0, os.path.join(STUDENT_2_DIR, "backend"))
