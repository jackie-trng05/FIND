"""Cross-service HTTP client for the Application service.

Centralises the outbound calls to everything that is not this service's own
database: the shared-api (session validation), the shared users database, the
postings database, Student 1's profile/resume database and Student 4's
interviews database. Following the repo convention, cross-student reads go
frontend -> own backend -> other student's DB service (never another student's
backend).
"""
...
def remove_interviews_for_application(application_id):
...
# --------------------------------------------------------------------------- #
# Student-1 profile / resume integration                                      #
# --------------------------------------------------------------------------- #
#
