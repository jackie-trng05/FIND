...
seed = [
    (2,  1, "Alex Morgan",    "HR-001", 5, 4, 4, 5, 4, 4.4, "Hire"),
    (5,  1, "Alex Morgan",    "HR-001", 3, 3, 4, 3, 4, 3.4, "Reject"),
    (6,  2, "Sarah Mitchell", "HR-002", 4, 5, 3, 4, 5, 4.2, "Hire"),
    (8,  2, "Sarah Mitchell", "HR-002", 2, 2, 3, 2, 3, 2.4, "Reject"),
    (10, 3, "James Chen",     "HR-003", 4, 4, 5, 4, 4, 4.2, "Hire"),
    (12, 3, "James Chen",     "HR-003", 5, 5, 4, 5, 5, 4.8, "Hire"),
    (14, 1, "Alex Morgan",    "HR-001", 3, 4, 3, 3, 3, 3.2, None),
    (16, 4, "Laura Williams", "HR-004", 4, 3, 4, 4, 3, 3.6, "Hire"),
    (17, 4, "Laura Williams", "HR-004", 1, 2, 2, 1, 2, 1.6, "Reject"),
    (15, 5, "Robert Taylor",  "HR-005", 4, 4, 4, 3, 4, 3.8, None),
]
